package com.rinal.submission2.match.prevmatch
...
class PreviousMatchFragment : Fragment(), MatchView {
    ...
    override fun onCreateView(
        ...
        presenterMatch.getPrevMatch(idLeague!!)
    ...
    override fun onDataLoaded(data: MatchResponse?) {
        ...
        rvMatchPrev.layoutManager = LinearLayoutManager(context)
        rvMatchPrev.adapter = adapter
    }
